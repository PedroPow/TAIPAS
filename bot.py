...
CARGO_MAP = {
    "Gerente": (1446707117380734996, 1446721622466629713),
    "Soldado": (1446707139643965644, 1446721622466629713),
    "Vapor": (1446707085114085417, 1446721622466629713),
}
QUEBRADA_MAP = {
    ...
    async def aceitar(self, interaction: discord.Interaction, button: Button):
        ...
        try:
            ...
            if role_id:
                ...
                if role and member:
                    await member.add_roles(role, reason="SET aprovado - cargo")
        except Exception:
            pass
